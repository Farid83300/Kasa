 ...
 */
export const mockConversations: Conversation[] = Array.from({ length: 8 }).map(
  (_, index) => ({
    id: `conv-${index}`,
    ...
    messages: [
      {
        id: `${index}-1`,
        sender: "host",
        content: "Bonjour, votre appartement est-il disponible pour le week-end du 12 au 14 octobre ?",
        timestamp: "11:04pm",
      },
      {
        id: `${index}-2`,
