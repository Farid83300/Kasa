import { PropertyDetail } from '@/types/logement';

/**
 * Instantané statique des logements — utilisé uniquement en mode démo
 * (NEXT_PUBLIC_DEMO_MODE=true, configuré sur Vercel) pour un déploiement
 * frontend-only sans backend live, conformément à la recommandation OpenClassrooms.
 * Généré depuis les vraies données de l'API le 12/07/2026 — voir lib/properties.ts
 * pour la logique de bascule.
 */
export const mockProperties: PropertyDetail[] = [
  ...
  },
  {
    ...
    equipments: ['Four', 'Frigo', 'Hotte', 'Micro-Ondes', 'Télévision', 'Wi-fi'],
    tags: ['Apt de Charme', 'Vue Parc'],
  },
  {
    id: '6ff132c6',
    ...
    equipments: ['Four', 'Frigo', 'Micro-Ondes', 'Wi-fi', 'Équipements de base'],
    tags: ['13e', 'Charmant', 'Studio'],
  },
  {
    id: '2139a317',
    ...
    equipments: ['Bouilloire', 'Micro-Ondes', 'Wi-fi'],
    tags: ['Métros', 'Vue Parc'],
  },
  {
    id: 'b4c67936',
    ...
    equipments: ['Bureau', 'Frigo', 'Parking', 'Salle de bains', 'Sèche Cheveux', 'Wi-fi'],
    tags: ['18ème', 'Cheap', 'Transports'],
  },
  {
    id: '7cbb378e',
    ...
    tags: ['Forêt', 'Grande maison', 'Nature'],
  },
  {
    id: '1e181317',
    ...
    equipments: ['Baie vitrée', 'Four', 'Frigo', 'Micro-Ondes', 'Parking', 'Télévision', 'Wi-fi'],
  ...
  },
  {
    ...
    equipments: ['Baignoire', 'Frigo', 'Micro-Ondes', 'Wi-fi', 'Équipements de base'],
  ...
  },
  {
    ...
    tags: ['Appartement', 'Canal Saint Martin', 'République'],
  },
  {
    id: 'ba55a0cc',
  ...
  },
  {
    ...
    equipments: ['Chambre Séparée', 'Climatisation', 'Micro-Ondes', 'Télévision', 'Wi-fi'],
    tags: ['Marais', 'Night Life', 'Parc', 'Parmentier'],
  },
  {
    id: 'f72a452f',
    ...
    tags: ['Charme', 'Culture', 'Montmartre'],
  },
  {
    id: '46d188c5',
    ...
    equipments: ['Cuisine équipée', 'Sèche Cheveux', 'Télévision', 'Wi-fi'],
  ...
  },
  {
    ...
    equipments: ['Bouilloire', 'Lit', 'Rangements', 'Sèche Cheveux', 'TV', 'Wi-fi'],
    tags: ['Commerces', 'Marais', 'Proche Métros', 'République', 'Studio'],
  },
  {
    id: 'cb2f9222',
    ...
    equipments: ['Climatisation', 'Machine à laver', 'Parking', 'Sèche Cheveux', 'Wi-fi'],
    tags: ['Commerces', 'Famille', 'Montparnasse'],
  },
  {
    id: 'bc6f7112',
